...
class GetCommands(commands.Cog):
    ...
    async def get_movie(
        ...
        embed.add_field(name="Director", value=movie.director.name)
        embed.add_field(name="Composer", value=movie.composer.name)
        embed.add_field(name="Studio", value=movie.studio.name)
